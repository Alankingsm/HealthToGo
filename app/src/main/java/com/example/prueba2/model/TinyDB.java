...
public class TinyDB {
    ...
    public ArrayList<ItemList> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ItemList> playerList =  new ArrayList<ItemList>();

        for(String jObjString : objStrings){
            ItemList player  = gson.fromJson(jObjString,  ItemList.class);
    ...
    public void putListObject(String key, ArrayList<ItemList> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ItemList player: playerList){
